...
public class DiagnosisServiceTest {
    ...
    public void testAddOrUpdateDiagnosis_NewDiagnosis() {
        ...
        savedDiagnosis.setPrescription("Rest and fluids");
    ...
    public void testAddOrUpdateDiagnosis_ExistingDiagnosis() {
        ...
        dto.setPrescription("Updated: Rest and fluids");
        ...
        existingDiagnosis.setPrescription("Rest and fluids");
        ...
        updatedDiagnosis.setPrescription("Updated: Rest and fluids");
